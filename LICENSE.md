...
❌ **NÃO PODE:**
- Vender ou cobrar pela extensão
- Redistribuir comercialmente
- Criar versões pagas/premium
...
**"Software"** refere-se à extensão PawnPro e todo seu código-fonte, documentação, assets e arquivos relacionados.

**"Você"** refere-se à pessoa física ou jurídica exercendo as permissões concedidas por esta licença.

**"Uso Comercial"** significa usar o Software em atividades que geram receita, lucro ou compensação financeira.

**"Venda"** significa cobrar dinheiro, criptomoedas ou qualquer compensação pela distribuição do Software ou suas versões modificadas.

**"Modificação"** significa qualquer alteração, adição, remoção ou derivação do código-fonte original.
...
### 2.2 VISUALIZAÇÃO E ESTUDO
- Acessar e estudar o código-fonte
...
### 3.1 VENDA E COMERCIALIZAÇÃO
- Vender o Software, modificado ou não
- Cobrar qualquer valor pela distribuição
- Incluir o Software em pacotes pagos
- Oferecer versões "premium", "pro" ou "empresarial" mediante pagamento
- Monetizar através de doações obrigatórias para acesso
...
- Oferecer extensões ou plugins pagos baseados neste código
- Desenvolver produtos derivados comerciais sem autorização expressa

### 3.4 REMOÇÃO DE ATRIBUIÇÕES
- Remover, ocultar ou modificar avisos de copyright
- Remover créditos ao autor original
- Apresentar o Software ou suas modificações como trabalho próprio original
- Alterar ou remover esta licença

### 3.5 USOS MALICIOSOS
- Usar o Software para atividades ilegais
- Criar versões que violem direitos autorais de terceiros
- Implementar funcionalidades para pirataria, cracking ou bypass de proteções
- Distribuir versões que contenham malware, spyware ou código malicioso

---

## 4. REDISTRIBUIÇÃO GRATUITA

Redistribuição gratuita é **permitida** sob as seguintes condições:

### 4.1 REQUISITOS OBRIGATÓRIOS
Você deve:
- ✅ Incluir uma cópia completa desta licença
- ✅ Manter todos os avisos de copyright intactos
- ✅ Dar crédito claro ao projeto original (PawnPro by NullSablex)
- ✅ Não apresentar como produto comercial ou proprietário
- ✅ Incluir link para o repositório oficial: https://github.com/NullSablex/PawnPro

### 4.2 MODIFICAÇÕES REDISTRIBUÍDAS
Se redistribuir versões modificadas gratuitamente:
- Deve identificar claramente as modificações realizadas
- Deve incluir data das modificações
- Deve manter esta licença
- Não pode implicar endosso do autor original
...
### 5.2 DIREITOS DO AUTOR
O autor original reserva-se o direito de:
- Aceitar ou rejeitar contribuições a seu critério
- Modificar contribuições aceitas
- Mudar a licença do projeto no futuro (não afetará versões já distribuídas)

---

## 6. LICENCIAMENTO COMERCIAL

### 6.1 PERMISSÕES ESPECIAIS
Para obter permissões além das concedidas nesta licença, incluindo:
- Venda do Software ou versões modificadas
- Uso em produtos SaaS comerciais
- Desenvolvimento de extensões proprietárias
- Licenciamento white-label

Entre em contato com o autor para negociar uma licença comercial separada.
...
"PawnPro" e logos associados são marcas do autor original. Esta licença não concede direito de usar marcas comerciais, exceto conforme necessário para:
- Identificar a origem do Software
- Dar crédito apropriado
- Links para o repositório oficial
...
- PRECISÃO, CONFIABILIDADE OU DISPONIBILIDADE
...
- QUALQUER DANO RESULTANTE DO USO OU IMPOSSIBILIDADE DE USO

MESMO QUE TENHA SIDO AVISADO DA POSSIBILIDADE DE TAIS DANOS.
```

### 8.3 RISCO
Você assume total responsabilidade por:
- Avaliar a adequação do Software para seus propósitos
- Resultados obtidos com o uso do Software
- Manutenção e suporte do Software
...
### 10.4 MODIFICAÇÕES
Esta licença não pode ser modificada exceto por escrito e assinado pelo autor original.

### 10.5 RENÚNCIA
A falha em exercer qualquer direito não constitui renúncia desse direito.

---

## 11. CLASSIFICAÇÃO DA LICENÇA

Esta é uma **licença de código-fonte disponível (source-available)**, não uma licença de código aberto (open source) conforme definida pela Open Source Initiative (OSI).

Razão: Restrições sobre venda e redistribuição comercial não atendem à definição de "open source" da OSI.
...
## RESUMO LEGAL (NÃO SUBSTITUI A LICENÇA COMPLETA)
