...
export function createMsg(t: Translate) {
  ...
  settings: {
    ...
    serverKeepHistory: () => t('Guardar comandos enviados'),
    serverKeepHistoryDesc: () => t('O histórico e os favoritos ficam em .pawnpro/state.json, restrito ao seu usuário e fora do controle de versão. Comandos que pareçam trazer senha nunca são guardados.'),
    serverSensitiveCommands: () => t('Comandos que não devem ser guardados'),
    serverSensitiveCommandsDesc: () => t('Comandos do seu gamemode que recebem senha ou token. A extensão já reconhece login, rcon_password e senhas passadas como argumento.'),
  ...
  serverView: {
    ...
    emptyHistoryHint: () => t('Os comandos que você enviar aparecem aqui.'),
    emptyFavorites:   () => t('Nenhum favorito'),
    emptyFavoritesHint: () => t('Marque um comando com a estrela para tê-lo sempre à mão.'),
    noMatchesHint:    () => t('Tente outro trecho do comando.'),
