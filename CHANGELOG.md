...
### Alterado
- **Painel de comandos do servidor revisto** — o botão "Enviar" vira um ícone (mesmo traço do editor, desenhado no próprio painel para acompanhar o tema), e **Favoritos** e **Últimos comandos** passam a dividir o mesmo espaço em duas abas, com a contagem de itens em cada uma. Antes eram duas listas empilhadas, que espremiam o painel. O botão "Limpar" segue a aba visível
